...
import sophieImg from "../assets/9925874_4243109.jpg"
    ...
    <div className="min-h-screen text-foreground" style={{ backgroundColor: "#040026" }}>
      ...
      <main>
        ...
        <div className="flex max-w-7xl flex-wrap mx-auto  justify-center" style={{ rowGap: "50px", columnGap: "100px", marginTop: "70px" }}>
          ...
          <CharacterCard name="Luna" description="She is good " imageSrc={heroImage} onClick={() => { navigate(buildChatUrl("Luna", sophieImg)) }}></CharacterCard>
          <CharacterCard name="Kai" description="He is good " imageSrc={heroImage} onClick={() => { navigate(buildChatUrl("Kai", sophieImg)) }} ></CharacterCard>
          <CharacterCard name="Milo" description="He is good " imageSrc={heroImage} onClick={() => { navigate(buildChatUrl("Milo", sophieImg)) }}></CharacterCard>
        </div>
